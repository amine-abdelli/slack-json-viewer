...
export const es: Messages = {
  ...
  connect: {
    ...
    qrRecognised:
      "Imagen reconocida ({size}). El código caduca enseguida — conéctate ahora. Si Slack te envía a la página de inicio de sesión de tu empresa, aparecerá aquí.",
    liveTitle: "Navegador de inicio de sesión",
    liveHint: "Este navegador se ejecuta en el servidor. Si aparece una página de inicio de sesión (el SSO de tu empresa), haz clic y escribe directamente en la imagen para autenticarte.",
    liveWaiting: "Abriendo el navegador…",
    liveKeyboard: "Teclado activo",
    liveFocus: "Haz clic en la imagen para interactuar con la página",
  ...
  importer: {
    ...
    liveIdp: "Proveedor de identidad",
    liveBack: "Volver a Loquarium",
  ...
  server: {
    ...
    liveGone: "Esta conexión ha terminado o no se encuentra.",
