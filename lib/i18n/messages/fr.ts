...
export const fr = {
  ...
  importer: {
    ...
    withImages: "Importer les captures d'écran",
    withImagesHint: "Les images des messages, en taille moyenne, gardées sur cet appareil.",
    imagesProgress: "Images {done}/{total}",
    images: plural({ one: "{n} image", other: "{n} images" }),
    imagesMissing: plural({ one: "{n} indisponible", other: "{n} indisponibles" }),
    extensionOutdated: "Mettez à jour l'extension Loquarium pour importer les images.",
    skipped: "ignorée",
  ...
  archive: {
    ...
    wrote: "Participants",
    reactedOrMentioned: "Ont réagi ou été mentionnés",
    showMorePeople: plural({ one: "Afficher {n} de plus", other: "Afficher {n} de plus" }),
    showFewer: "Réduire",
